...
export const UserDashboard: React.FC<UserDashboardProps> = ({ 
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-slate-50">
      ...
      {/* ÁREA DE JOGO (TOPO) - SEM CABEÇALHOS INTERNOS, PAINÉIS NO TOPO */}
      <div className="flex-1 flex flex-col p-2 md:p-3 overflow-hidden">
        
        {/* ÁREA SCROLLÁVEL DE CONTEÚDO */}
        <div className="flex-1 overflow-y-auto space-y-3 pr-1 scrollbar-hide">
          {/* Painel de Prêmios - POSIÇÃO ZERO (TOPO ABSOLUTO) */}
          ...
          {cards.length === 0 && (
            <div className="text-center py-16 bg-white rounded-3xl border-2 border-dashed border-slate-200">
              ...
              <p className="text-slate-400 font-bold uppercase text-[9px] tracking-widest">Aguardando início ou compra de séries</p>
            </div>
          )}
        </div>
      </div>

      {/* CHAT INFERIOR - AMPLIADO PARA 45% DA ALTURA (45vh) PARA MELHOR USABILIDADE */}
      <div className="h-[45vh] w-full border-t border-slate-200 bg-white z-20 flex flex-col shadow-[0_-8px_30px_rgba(0,0,0,0.15)]">
        <Chat 
          messages={messages} 
